    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-4 py-3.5 bg-background border border-border/50 rounded-2xl">
      ...
      <div className="flex items-center gap-2 w-full sm:w-auto">
        ...
        {onAdd && (
          <button
            onClick={onAdd}
            className="flex items-center cursor-pointer gap-1.5 h-9 px-3.5 rounded-lg bg-foreground text-background text-[13px] font-medium shrink-0 hover:opacity-85 active:scale-[.98] transition-all"
          >
